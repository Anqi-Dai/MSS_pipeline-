...
ring <- bars_ %>% 
  ...
  mutate(ring_height = round(ring_height, 1)/2,
...
cat ../data/cleaned_tree/Annot_tree.txt ../data/source/ring_itself.txt > ../data/cleaned_tree/Annot_tree2.txt 
...
graphlan.py guide_1_new.xml ../../figs/paper/080_food_tree_ring.pdf --dpi 400 --size 3 --pad 0
graphlan.py guide_1_new.xml ../../figs/paper/080_food_tree_ring.svg --dpi 400 --size 3 --pad 0
```
