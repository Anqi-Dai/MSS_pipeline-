...
graphlan_annotate.py --annot ../cleaned_tree/Annot_tree.txt ../cleaned_tree/output_food_tree_datatree_name.newick  guide_1_new.xml
graphlan.py guide_1_new.xml food_tree_ring.pdf --dpi 300 --size 3.5 
```
