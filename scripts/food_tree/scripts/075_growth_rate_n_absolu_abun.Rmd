...
irep = entero %>% 
  ...
  labs(x = '',
       ...
       title = 'Enterococcus growth rate')+
  theme_classic()+
...
all_sweet_box <- ggboxplot(all_sweet,  y = "sweetdaily", add = 'jitter',add.params = list(alpha = 0.05),
                          xlab = '', ylab = 'All patients sweet daily intake')+
   theme_classic() +
...
```{r}
p11_ver <- plot_grid(sweets_time, fruit_time, both_time, irep, copies, byrow = F,
          ncol = 1, axis = 'ltbr', align = 'hv')
p11_ver
 

ggsave('../figs/paper/075_irep_p11_vertical.pdf', width = 100,
