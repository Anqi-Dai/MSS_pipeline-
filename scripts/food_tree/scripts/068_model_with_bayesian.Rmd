...
In this script, the max and the mean are from the EN-less records. 9 food groups.
...
top3grp <- dtb %>% 
  ...
  left_join(key) %>% 
  ungroup() %>% 
  mutate(log10gram = log10(total_per_code)) %>% 
...
ggdotchart(top3grp, x = "description", y = "log10gram",
           xlab = 'Food item description', ylab = 'Total consumed in dehydrated weight\nlog10 transformed',
...
ggsave('../figs/paper/068_top5_eaten_foods_of_679.pdf', width = 5, height = 4)
ggsave('../figs/paper/068_top5_eaten_foods_of_679.jpg', width = 7, height = 6)
``` 
...
ggsave('../figs/paper/068_fig2_model_coeff_forest.eps',  width = 100,
       height = 100,
         #height = 60,
         units = c("mm"),
         dpi = 400, device = 'eps')
...
only2 <- post_diff_df %>% 
  filter(term %in% c('fg_fruit','fg_sweets')) 
...
ggsave('../figs/paper/068_fig2_fg2_post_diff.eps',  width = 80,
       height = 80,
         #height = 60, 
         units = c("mm"),
         dpi = 400, device = 'eps')
...
ggsave('../figs/paper/068_fig2_fg9_post_diff.eps',  width = 100,
       height = 100,
         #height = 60,
         units = c("mm"),
         dpi = 400, device = 'eps')
