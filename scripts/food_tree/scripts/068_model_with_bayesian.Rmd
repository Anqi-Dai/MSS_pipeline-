...
coeff_bi <- post_samples %>% 
  ...
  mutate(item_name = case_when(
    ...
    item ==  'b_empiT' ~ 'Empirical abx exposure',
    item == 'b_empiF' ~ 'No empirical abx exposure',
    item == 'b_tpnT' ~ 'TPN exposure',
    item == 'b_tpnF' ~ 'No TPN exposure',
    item ==  'b_enT' ~ 'EN exposure', 
    item ==  'b_enF' ~ 'No EN exposure'
  )) %>% 
