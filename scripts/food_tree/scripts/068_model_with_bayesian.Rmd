...
top3grp <- dtb %>% 
  ...
  mutate(fg1_full_name = factor(fg1_full_name, levels = c('Fruits','Vegetables','Sugars, Sweets & Beverages')))
...
ggdotchart(top3grp, x = "description", y = "log10gram",
   ...
   palette = c('#7D3C98','#229954','#db2589'),
   rotate = TRUE,
   sorting = "descending", 
   ggtheme = theme_bw(),
   y.text.col = TRUE ) +
...
ggsave('../figs/paper/068_top10_eaten_foods_of_679.pdf', width = 7, height = 6)
ggsave('../figs/paper/068_top10_eaten_foods_of_679.jpg', width = 7, height = 6)
``` 
...
ggsave('../figs/paper/fig2_model_coeff_forest.eps',  width = 100,
       height = 100,
         #height = 60,
         units = c("mm"),
         dpi = 400, device = 'eps')
