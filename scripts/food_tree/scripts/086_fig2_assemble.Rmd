...
f2d <- read_rds('../data/101_f2d_diversity_pred_diff_with_sigma.rds')

#f2e <- read_rds('../data/087_entero_genus_fg_main.rds')
f2e <- read_rds('../data/120_F2E_extra_genera.rds')

ggsave('../data/086_f2e.pdf', width = 3,height = 3, plot = f2e)
...
ggsave('../data/F2_model_results_086.pdf',
       width = 250,
       height = 180,
         #height = 60,
         units = c("mm"),
...
ggsave('../figs/paper/S_div_factor_086.pdf',
       width = 100,
       height = 60, 
         #height = 60,
         units = c("mm"),
         dpi = 400, device = 'pdf', plot = div_fac)
```
...
ggsave('../figs/paper/S4_div_entero_prior_086.jpg',
       width = 170, height = 60, units = c("mm"),
         dpi = 400, device = 'jpg', plot = prior)
```
