...
abx_time <- ggplot(abx, aes(x = startdrt, y = yval, xend = stopdrt, yend = yval, label = drugfull )) +
  geom_segment(
     size = 3, lineend = 'square', alpha = 0.5
  ) +
...
abx_time %>% write_rds('../data/095_abx_time.rds')
sweets_time %>% write_rds('../data/095_sweets_time.rds')
violin9 %>% write_rds('../data/095_violin9.rds')
fruit_time %>% write_rds('../data/095_fruit_time.rds')
violin6 %>% write_rds('../data/095_violin6.rds')
irep %>% write_rds('../data/095_irep.rds')
all_kle %>% write_rds('../data/095_all_kle.rds')
copies %>% write_rds('../data/095_copies.rds')
```
...
ggsave('../figs/paper/095_irep_kle_vertical.pdf', width = 110,
...
ggsave('../figs/paper/095_right.pdf', width = 120,
      height = 300, units = 'mm', dpi = 400)
