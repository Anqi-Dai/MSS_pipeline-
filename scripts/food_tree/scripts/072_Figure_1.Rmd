...
umap_faith <- another %>% 
  ...
  ggscatter(x = 'taxumap1', y = 'taxumap2', color = 'faith_pd', alpha = 0.8,size = umap_pt_size, shape = 16,
            xlab = '', ylab = '') +
  scale_color_viridis() +
  theme_classic() +
  #lemon::coord_capped_cart(bottom = 'both', left = 'both') +
...
umap_caloric <- umap_cal %>% 
  arrange(desc(n)) %>% 
  ggscatter(x = 'taxumap1', y = 'taxumap2', color = 'daycal', alpha = 0.8,size = umap_pt_size , shape = 16,
            xlab = '', ylab = '') +
...
umap_drt_high_to_low_bin <- umap_time_df %>% 
   arrange(desc(fdrt)) %>% 
  #arrange(fdrt) %>% 
   ggscatter(x = 'taxumap1', y = 'taxumap2', color = 'bin', alpha = 0.8, size = umap_pt_size, shape = 16,
             xlab = '', ylab = '') + 
