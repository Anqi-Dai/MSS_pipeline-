...
pick_cal <- day_calori %>% 
  ...
  scale_y_continuous(
    ...
    sec.axis = sec_axis(~ . * 0.5, name = "Diet \u03b1 diversity")
  ) +
  geom_point(pick_diet_al, mapping = aes(x = fdrt, y = faith_pd)) +
  geom_line(pick_diet_al, mapping = aes(x = fdrt, y = faith_pd), linetype = 'dashed') 
pick_cal
...
```{r assemble_all}
top <- plot_grid(fig1_timeline, daym5, tree, fig1_umap,
