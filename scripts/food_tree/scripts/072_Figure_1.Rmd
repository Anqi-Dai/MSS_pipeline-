...
ggsave('../data/072_stool_alpha.pdf',width = 3, height = 3, dpi = 300, plot = stool_alpha)
```
...
ggsave('../data/072_day_cal.pdf',width = 3, height = 3, dpi = 300, plot = day_cal)
```
...
ggsave('../data/072_alphadiet.pdf',width = 3, height = 3, dpi = 300, plot = diet_alpha)
```
...
The below umap is updated in the 162
...
# the macronutrients 3 by 2 panel inserted to the middle row
