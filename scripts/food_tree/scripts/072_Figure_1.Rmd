...
stool_alpha <- meta %>% 
  ...
  #geom_point(data = pick_stool, aes(x = sdrt, y = simpson_reciprocal), col = 'red', size = pick_point_size, shape = 'triangle') +
...
ggsave('../figs/paper/bot_fig1_stool_alpha.tiff',
       width = 60,
       height = 60,
         #height = 60,
         units = c("mm"),
         dpi = 400, device = 'tiff', plot = stool_alpha)
```
