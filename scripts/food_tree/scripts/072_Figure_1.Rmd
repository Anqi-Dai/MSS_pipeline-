...
```{r 3X2}
m_panel <- dailymacro %>% 
   ggscatter(x = 'fdrt', y = 'eachsum', alpha = 0.009, size = point_size, 
            xlab = 'Transplant day',title = 'Macronutrients',
            ylab = 'Grams',
            add = "loess", conf.int = TRUE, 
            add.params = list(color = diet_line_color, fill = "hotpink", size = 1))  +
...
fg_panel <- fg_total %>% 
   ggscatter(x = 'fdrt', y = 'eachsum', alpha = 0.009, size = point_size, 
            xlab = 'Transplant day',title = 'Food groups',
            ylab = 'Grams',
            add = "loess", conf.int = TRUE, 
            add.params = list(color = diet_line_color, fill = "hotpink", size = 1))  +
  facet_wrap(~ grp, 
...
middle_row <- plot_grid(NA,m_panel, fg_panel, stool_two,
          nrow = 1, 
          align = 'hv',
          rel_widths =  c(.8,1.2,1.4,.8),
          labels = c(NA, 'I', 'J', "K"),
          axis = 'tblr')
...
```{r}
# assemble all
f1 <-  plot_grid(top_row, middle_row,NA,
                 rel_heights = c(1,1,1),
                 nrow = 3)
