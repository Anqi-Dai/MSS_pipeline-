...
div_priors <- c(# for the food group variables
            ...
            # for the intensity 
            prior(normal(0, 0.1), class = 'Intercept', coef = "intensityReducedTRUE"),
            prior(normal(0, 0.1), class = 'Intercept', coef = "intensityAblativeTRUE"),
            prior(normal(0, 0.1), class = 'Intercept', coef = "intensityNonablativeTRUE")
            )
```
...
ggsave('../data/173_diversity_interaction.pdf', width = 12, height = 6)
