...
conditional9 <- conditional %>%   
  ...
  theme_classic() +
  theme(legend.position = c(0.5, 0.05), legend.title = element_text(size = 8, face="bold"),
...
rawsweets <- META %>% 
  ...
  ggscatter(x = 'fg_sweets', y = 'log_div', color = 'antibiotics',
           ...
           cor.coeff.args = list(method = "spearman",  label.sep = " \\n", cor.coef.name = c("rho"),p.accuracy = 0.01, r.accuracy = 0.01,label.x.npc = "left", label.y.npc = "bottom", size = 2)) +
  scale_x_sqrt() +
  scale_y_sqrt() +
...
legend9 <- get_legend(conditional9)   
bottom_left <- plot_grid(rawsweets, )
```
