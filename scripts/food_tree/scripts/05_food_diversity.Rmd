...
qiime phylogeny midpoint-root --i-tree  output_food_tree_datatree.qza \
  --o-rooted-tree output_food_tree_datatree_rooted.qza
...
qiime diversity alpha-phylogenetic \
  ...
  --i-phylogeny ../source/output_food_tree_datatree_rooted.qza \
  --p-metric faith_pd \
