...
spearman_res_plot %>% 
  ggscatter(x = 'rho', y = 'neglogFDR', size = 'med_wt',
            xlab = 'Spearman rho', ylab = '-log(FDR)', title = 'Volcano plot level 2 food group dewt VS simpson r diversity', color = 'Level.code',
            alpha = 0.7 , label = 'Level.code', repel = T, legend = 'none') +
