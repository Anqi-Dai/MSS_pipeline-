...
# combine the above like essential diet columns from old and the new to create a ALL table

```{r}
old <- read_csv('../data/cleaned_diet_data/diet_records_corrected_67.csv')
