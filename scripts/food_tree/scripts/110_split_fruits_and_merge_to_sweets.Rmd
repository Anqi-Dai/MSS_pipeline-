---
title: "Split the fake fruits out and merge to the sweets group"
...
model_2 <- log(simpson_reciprocal) ~ 0 + 
                fg_fruit+
               fg_meat+
               fg_milk+
               fg_oils+
...
post_res <- suppressWarnings(posterior_samples(model_new_sweets)) 
post_res %>%  write_csv('../data/110_div_model_fg_post_new_sweets.csv')
```
```{r}
