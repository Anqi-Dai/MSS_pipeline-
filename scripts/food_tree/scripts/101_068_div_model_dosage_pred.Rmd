...
# more experimenting cuz I'm a responsible person 

for diet in alldiets:

     predicted_diversity <- posterior  * diet  

     predicted_diversity_sweetshigh <- posterior * (diet + max sweet)

     predicted_diversity_fruitshigh <- posterior * (diet + maxfruit)

     predicted_diff_sweets = predicted_diversity - predicted_diversity_sweetshigh


     predicted_diff_fruits = predicted_diversity - predicted_diversity_fruitshigh


where posterior = 500 samples

This means you are collecting 500 differences per diet (over alldiets).
