...
The config file should be named "dbConfig.txt" and has the following info for this example user (currently with the temprary password).

```{bash}
# I created the below file name just to show what the format should be like
cat ~/dbConfig_format_example.txt
```
